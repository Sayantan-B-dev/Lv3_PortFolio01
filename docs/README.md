...
Everything about this workspace, written for future-you (and future-me).

| Doc | Covers |
|---|---|
| [environment](environment.md) | Every env var, where it lives, what breaks without it |
| [blog-system](blog-system.md) | Routes, API, data model, CRUD, uploads, seeding |
