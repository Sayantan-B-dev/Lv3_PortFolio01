...
- **Timeline**: experience and education with a scroll-growing gradient line

All motion disabled under `prefers-reduced-motion`; native cursor preserved on touch devices.

## Sections

Hero → tech ticker → About/Statement → Selected Work → Stack → Path (experience and education) → Contact and Certifications → footer.
